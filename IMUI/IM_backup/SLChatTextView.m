...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [SLChatTextView maxCharactersPerLine];
...
- (NSUInteger)numberOfLinesOfText {
    return [SLChatTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [SLChatTextView maxCharactersPerLine]) + 1;
}
