...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[EaseMob sharedInstance].chatManager asyncLoginWithUsername:@"58_test2" password:@"111111"];
    SLChatViewController * chatViewController = [[SLChatViewController alloc] initWithChatter:@"58_test1"];
