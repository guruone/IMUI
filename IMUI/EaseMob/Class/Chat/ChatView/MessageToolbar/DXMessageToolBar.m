...
- (void)setupSubviews
{
    ...
    [self.styleChangeButton setImage:[UIImage imageNamed:@"im_voice"] forState:UIControlStateNormal];
    [self.styleChangeButton setImage:[UIImage imageNamed:@"im_keyboard"] forState:UIControlStateSelected];
    ...
    [self.moreButton setImage:[UIImage imageNamed:@"im_more"] forState:UIControlStateNormal];
    [self.moreButton setImage:[UIImage imageNamed:@"im_more"] forState:UIControlStateHighlighted];
    ...
    [self.faceButton setImage:[UIImage imageNamed:@"im_face"] forState:UIControlStateNormal];
    [self.faceButton setImage:[UIImage imageNamed:@"im_face"] forState:UIControlStateHighlighted];
    [self.faceButton setImage:[UIImage imageNamed:@"im_keyboard"] forState:UIControlStateSelected];
...
//    self.inputTextView.contentMode = UIViewContentModeCenter;
    ...
    _inputTextView.backgroundColor = HYHexToRGB(0xf5f5f5);
    ...
    if (!self.moreView) {
        ...
        self.moreView.backgroundColor = HYHexToRGB(0xedeef5);
    ...
    if (!self.faceView) {
        ...
        self.faceView.backgroundColor = HYHexToRGB(0xedeef5);
        self.faceView.autoresizingMask = UIViewAutoresizingFlexibleTopMargin;
    }
    
    if (!self.recordView) {
        //(90, 130, 140, 140)
        self.recordView = [[DXRecordView alloc] initWithFrame:CGRectMake(90, 130, 160, 160)];
    }
...
- (void)willShowBottomHeight:(CGFloat)bottomHeight
{
    ...
    CGRect toFrame = CGRectMake(fromFrame.origin.x, fromFrame.origin.y + (fromFrame.size.height - toHeight) /*kScreenHeight - toHeight*/, fromFrame.size.width, toHeight);
